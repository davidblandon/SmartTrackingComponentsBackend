...
def create_component_route(name : str, nature: NatureEnum ,Uploaded_file: UploadFile = File(...),admin: User = Depends(admin_required)):
...
def get_all_components(admin: User = Depends(admin_required)):
